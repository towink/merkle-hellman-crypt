...
\author{Anna Piezrak\\Diego Kiedanksi\\Tobias Winkler\\Criptografía y Teoría de Códigos\\Universidad Complutense de Madrid} %if necessary, replace with your course title
...
\vspace{1em}
\begin{algorithmic}[1]
\Procedure{ResolverMochilaSupercreciente}{$\{m_1,...,m_n\}$, $L$}
